...
namespace args 
{
    ...
    using param_version_t = glap::model::Flag<glap::Names<"version", 'v'>>;
    ...
    using command_generate_t = glap::model::Command<glap::Names<"generate", 'g'>, param_version_t, param_yaml_t, param_type_t, param_output_t>;
